    ...
    <div className="bg-background text-foreground py-20 px-4">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-lg text-muted-foreground mb-10">
          En AutoMercado, nos dedicamos a ofrecer los mejores autos usados del
          país con un servicio personalizado y transparente. Desde nuestros
          inicios en Buenos Aires, nos enfocamos en brindar una experiencia
          confiable para quienes buscan su próximo vehículo.
        </p>
      </div>
